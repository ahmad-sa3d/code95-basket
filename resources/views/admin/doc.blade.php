			...
			<div class="row">
				<div class="col-sm-4">
					<figure class="thumbnail">
						<img src="{{ url()->asset('images/documentation/sidebar.png') }}" alt="" class="">
					</figure>
				</div>
				<div class="col-sm-8">
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-sm-4">
					<figure class="thumbnail">
						<img src="{{ url()->asset('images/documentation/dashboard.png') }}" alt="" class="">
					</figure>
				</div>
				<div class="col-sm-8">
					<h4 class="label label-primary font-size-p1">Dashboard</h4>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-sm-4">
					<figure class="thumbnail">
						<img src="{{ url()->asset('images/documentation/users.png') }}" alt="" class="">
					</figure>
				</div>
				<div class="col-sm-8">
					<p class="">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-sm-4">
					<figure class="thumbnail">
						<img src="{{ url()->asset('images/documentation/products.png') }}" alt="" class="">
					</figure>
				</div>
				<div class="col-sm-8">
					<p class="">
	...
	<div class="panel panel-warning">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-sm-4">
					<figure class="thumbnail">
						<img src="{{ url()->asset('images/documentation/categories.png') }}" alt="" class="">
					</figure>
				</div>
				<div class="col-sm-8">
					<p class="">
	...
	<div class="panel panel-danger">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-sm-4">
					<figure class="thumbnail">
						<img src="{{ url()->asset('images/documentation/invoices.png') }}" alt="" class="">
					</figure>
				</div>
				<div class="col-sm-8">
					<p class="">
