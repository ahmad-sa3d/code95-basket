...
<body class="sidebar-fixed topnav-fixed">
    ...
    <div id="wrapper" class="wrapper">
        ...
        <?php echo $__env->make( 'admin.includes.topnav' , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div id="main-content-wrapper" class="content-wrapper with-sidebar">
            ...
            <?php echo $__env->make( 'admin.includes.maincontent' , array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
